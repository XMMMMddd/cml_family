...
source("cml家庭/FGWAS 优化版本/FGWAS 函数.R") # 加载 FGWAS 函数1
source("/Volumes/数据 1/cml 家庭项目/cml家庭/cml家庭函数/cml_friamly.r") # library(RcppArmadillo) library(Rcpp)
...
data <- generate_multiple_datasets_v3(
    ...
    # 选型婚配
    ## 选型婚配基因型
    prop_negative_pleiotropy = 0.5, compatibility_selection_prop = 0,
